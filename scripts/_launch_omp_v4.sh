...
rm -f persona_runs/dnd_good_scale/sae/ssv_omp_corpus_interp.json
rm -f persona_runs/dnd_evil/sae/ssv_omp_corpus_cache.json
rm -f persona_runs/dnd_evil/sae/ssv_omp_corpus_interp.json
rm -f persona_runs/dnd_lawful/sae/ssv_omp_corpus_cache.json
rm -f persona_runs/dnd_lawful/sae/ssv_omp_corpus_interp.json
rm -f persona_runs/dnd_chaotic/sae/ssv_omp_corpus_cache.json
rm -f persona_runs/dnd_chaotic/sae/ssv_omp_corpus_interp.json
sleep 2
nohup bash scripts/_remote_omp_interp.sh > logs/omp_interp_v4.log 2>&1 &
echo "PID=$!"
sleep 3
tail -5 logs/omp_interp_v4.log
